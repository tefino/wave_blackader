...
int main(int argc, char* argv[]) {
    ...
    prefix_id = "00000000000000000000000000000001";
    id = "0000000000000001";
    bin_id = hex_to_chararray(id);
    bin_prefix_id = hex_to_chararray(prefix_id);
    ...
    prefix_id = "00000000000000000000000000000002";
    id = "0000000000000001";
    bin_id = hex_to_chararray(id);
    bin_prefix_id = hex_to_chararray(prefix_id);
    ba->publish_info(bin_id, bin_prefix_id, DOMAIN_LOCAL, NULL, 0);
	...
	prefix_id = "00000000000000000000000000000003";
	id = "0000000000000001";
	bin_id = hex_to_chararray(id);
	bin_prefix_id = hex_to_chararray(prefix_id);
	ba->publish_info(bin_id, bin_prefix_id, DOMAIN_LOCAL, NULL, 0);
