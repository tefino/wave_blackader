...
public:
    ...
    void wave_handle_subscription(RemoteHost *_subscriber, String &ID, String &prefixID, unsigned char strategy);
	void wave_rendezvous(String &fullID, RemoteHostSet &publishers, RemoteHost* subscriber, unsigned int noofchunk) ;
